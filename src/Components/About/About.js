      ...
      <Row>
        <Col>
          <img
            className="about-img"
            src={aboutpic}
            alt="the boys at the beach"
          />
          <Container>
            <Row>
              <p>Frankie McGinn - Bass///</p>
              <p>Cody Smith - Guitar, Vox</p>
            </Row>
            <Row>
              <p>Rob Knox - Drums///</p>
              <p>Justin Jokinen - Guitar</p>
            </Row>
          </Container>
        </Col>
        <Col sm>
...
//           <img className="about-img" src={aboutpic} alt="the boys at the beach" />
//           <div className="members">
//             <p>Rob Knox - Drums</p>
//             <p>Justin Jokinen - Guitar</p>
//             <p>Cody Smith - Guitar, Vox</p>
//             <p>Frank McGinn - Bass</p>
//           </div>
//         </div>
